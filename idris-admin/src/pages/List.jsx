        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 py-6'>
          <div className='bg-white w-full max-w-3xl max-h-[90vh] overflow-y-auto border shadow-lg'>
            ...
            {!editMode ? (
              <div className='p-4 sm:p-6'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm'>
                  <div>
                    ...
                    <p className='font-medium text-gray-800 mt-1'>{selectedProduct.name}</p>
                  </div>
                  <div>
                    <p className='text-gray-500'>Price</p>
                    <p className='font-medium text-gray-800 mt-1'>${selectedProduct.price}</p>
                  </div>
                  <div>
                    <p className='text-gray-500'>Category</p>
                    <p className='font-medium text-gray-800 mt-1'>{selectedProduct.category}</p>
                  </div>
                  <div>
                    <p className='text-gray-500'>Sub category</p>
                    <p className='font-medium text-gray-800 mt-1'>{selectedProduct.subCategory}</p>
                  </div>
                  <div>
                  ...
                  <div className='sm:col-span-2'>
                    ...
                    <p className='text-gray-800 mt-1 leading-6'>{selectedProduct.description}</p>
                  </div>
                </div>
              ...
              <form onSubmit={updateProduct} className='p-4 sm:p-6 flex flex-col gap-4'>
                <div>
                ...
                <div className='flex items-center gap-2'>
                  <input
                    ...
                    onChange={() => setEditData((prev) => ({ ...prev, bestseller: !prev.bestseller }))}
                    id='edit-bestseller'
                    type='checkbox'
                  />
